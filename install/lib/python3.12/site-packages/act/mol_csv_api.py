...
# ACT python code
sys.path.insert(1, "/home/runner/work/ACT/ACT/install/lib/python3.12/site-packages/act")
...
dbdir = "ACTDATA"
try:
    ACTDATA = os.environ[dbdir]
except:
    print("Please set the %s environment variable" % dbdir)
    exit(1)
...
class Molecule:
    ...
    def from_row(self, row, version:int):
        ...
        if (len(row) < 22):
            print("row[0] %s invalid input" % ( row[0] ))
            return None
    ...
    def is_excluded(self):
        ...
        excluded_file = ACTDATA + "/excluded_molecules.csv"
...
class Molecules:
    ...
    def read(self, input_file:str, version, clean:bool):
        ...
        for row in rows:
            ...
            mol = Molecule(0)
            if None == mol.from_row(row, version):
