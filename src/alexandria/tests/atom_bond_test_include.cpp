...
TEST_F (AtomtypeTest, DimethylImidazole)
{
    testAtype("12-dimethyl-imidazole.sdf");
}

TEST_F (AtomtypeTest, PropaDienelydinephosphane)
{
...
TEST_F (BondtypeTest, 1EthoxyethylPhosphorylOxyethane)
{
    testAtype("1--ethoxyethylphosphoryl-oxyethane-3-oep.log.pdb");
}

TEST_F (BondtypeTest, 1Amino1Hydroxyguanidine)
{
    testAtype("1-amino-1-hydroxyguanidine-3-oep.log.pdb");
}

TEST_F (BondtypeTest, Dimethylguanidinium)
{
    testAtype("1-1-dimethylguanidinium.sdf");
}

TEST_F (BondtypeTest, Acetate)
{
    testAtype("acetate-3-oep.log.pdb");
}

TEST_F (BondtypeTest, AceticAcid)
{
    testAtype("acetic-acid-3-oep.log.pdb");
}

TEST_F (BondtypeTest, Acetone)
{
    testAtype("acetone-3-oep.log.pdb");
}

TEST_F (BondtypeTest, DiethylSulfate)
{
    testAtype("diethyl-sulfate-3-oep.log.pdb");
}

TEST_F (BondtypeTest, DisulfurMonoxide)
{
    testAtype("disulfur-monoxide-3-oep.log.pdb");
}

TEST_F (BondtypeTest, EthylSulfate)
{
    testAtype("ethyl-sulfate-3-oep.log.pdb");
}

TEST_F (BondtypeTest, Glutamate)
{
    testAtype("glutamate-3-oep.log.pdb");
}

TEST_F (BondtypeTest, GlutamicAcid)
{
    testAtype("glutamic-acid-3-oep.log.pdb");
}

TEST_F (BondtypeTest, HistidineHdHe)
{
    testAtype("histidine-hdhe-3-oep.log.pdb");
}

TEST_F (BondtypeTest, Nitromethane)
{
    testAtype("nitromethane-3-oep.log.pdb");
}

TEST_F (BondtypeTest, SulfurDioxide)
{
    testAtype("sulfur-dioxide-3-oep.log.pdb");
}

TEST_F (BondtypeTest, ThiazylFluoride)
{
    testAtype("thiazyl-fluoride-3-oep.log.pdb");
}

TEST_F (BondtypeTest, Water)
{
    testAtype("water-3-oep.log.pdb");
}

TEST_F (BondtypeTest, Aniline)
{
    testAtype("aniline.sdf");
}

TEST_F (BondtypeTest, EthaneDiamine)
{
    testAtype("ethane-12-diamine.sdf");
}

TEST_F (BondtypeTest, TrimethylImidazolium)
{
    testAtype("123-trimethyl-imidazolium.sdf");
}

TEST_F (BondtypeTest, DimethylImidazole)
{
    testAtype("12-dimethyl-imidazole.sdf");
}
