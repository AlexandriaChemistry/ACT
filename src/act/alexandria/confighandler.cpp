                                     ...
                                     gmx_unused std::vector<t_filenm> *fnms)
{
    std::vector<t_pargs> pa = {
        ...
        { "-adaptive_steps", FALSE, etBOOL, {&adaptiveStep_},
          "Use adaptive step sizes for each parameter in the training" },
                                  ...
                                  gmx_unused std::vector<t_filenm> *fnms)
{
    ...
    t_pargs pa[] = {
        ...
        { "-max_local_minimum_generations", FALSE, etINT, {&maxLocalMinimumGenerations_},
          "Generation limit for the best genome to stay in a local minimum. If the genome remains more than this number of generation in a local minimum, the evolution is assumed to be converged" },
