...
###
        ##    try:
            subprocess.run("./xyz2molprop.py -i {}/{}.xyz -o {}.xml -n {} -int {} -charge_a {} -charge_b {} -sel_a_end {} -sel_b_end {} -MIN {} -ID {} -FRAGA SEL_A.xyz -FRAGB SEL_B.xyz -ref {}".format(args.directory,name, name,name,benchmark,CHAR_A,CHAR_B,SEL_A_2,SEL_B_2, MIN, name, args.directory).split())
          ##  except:
