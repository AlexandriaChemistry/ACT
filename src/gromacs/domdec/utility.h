...
static inline real
atomToAtomIntoDomainToDomainCutoff(gmx_unused const gmx_domdec_comm_t &comm,
                                   real                     cutoff)
{
    return cutoff;
}
...
static inline real
domainToDomainIntoAtomToDomainCutoff(gmx_unused const gmx_domdec_comm_t &comm,
                                     real                     cutoff)
{
    return cutoff;
}
