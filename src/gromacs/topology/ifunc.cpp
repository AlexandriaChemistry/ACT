...
const t_interaction_function interaction_function[F_NRE] =
{
    ...
    def_nb      ("LJ12_6",   "LJ12_6 (SR)",         2, 2                                ),
    def_nb      ("LJ8_6",    "LJ8_6",         2, 2                                ),
    def_nb      ("LJ14_7",   "LJ14_7",         2, 4                                ),
    def_nb      ("WBHAM",    "Wang Buckingham (SR)",   2, 3                                ),
    def_nb      ("GBHAM",    "Generalize Buckingham (SR)",   2, 4                                ),
