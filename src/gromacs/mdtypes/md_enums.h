...
enum {
  eCOMB_GEOMETRIC, eCOMB_ARITHMETIC, eCOMB_LORENTZ_BERTHELOT, eCOMB_NONE, eCOMB_KONG_MASON, eCOMB_HOGERVORST, eCOMB_YANG, eCOMB_QI, eCOMB_QI_2, eCOMB_WALDMAN_HAGLER, eCOMB_WALDMAN_HAGLER_2, eCOMB_NR
};
