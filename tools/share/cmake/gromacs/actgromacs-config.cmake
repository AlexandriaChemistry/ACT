...
# import them.
set(_gmx_import_file ${_gmx_cmake_dir}/libactgromacs.cmake)
if (GROMACS_PREFER_STATIC OR NOT EXISTS ${_gmx_import_file})
    set(_gmx_import_file_static ${_gmx_cmake_dir}/libactgromacs_static.cmake)
...
if (NOT EXISTS ${_gmx_import_file})
    message(FATAL_ERROR
        ...
        "libactgromacs.cmake or libactgromacs_static.cmake to define the imported "
        "targets.")
endif()
include(${_gmx_import_file})
unset(_gmx_import_file)

get_target_property(_libs libactgromacs INTERFACE_LINK_LIBRARIES)
...
endforeach()
set(GROMACS_LIBRARIES libactgromacs )
set(GROMACS_DEFINITIONS -DGMX_DOUBLE=1)
set(GROMACS_IS_DOUBLE ON)
...
set(GROMACS_SUFFIX "")
set(GROMACS_CXX_COMPILER "/usr/bin/opal_wrapper")
