...
yielding the spectrum in :numref:`fig-ethanol`.
...
The *alexandria nma* used above to generate the infrared spectrum in :numref:`fig-ethanol`  computes the thermochemical variables as well (:numref:`tab-thermo`).
